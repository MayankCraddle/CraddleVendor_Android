...
class CityAdapter(private val context: Context, private var stateList: ArrayList<String?>?,
    ...
    inner class MyViewHolder(private val mBinding: AdapterStateListBinding) :
        ...
        fun bind(stateList: String?, position: Int){
            ...
            mBinding.releState.setOnClickListener {
                clickListener.onClickItem(position, MyConstants.CITY_REQ_CODE,stateList!!)
            }
        }
    }
